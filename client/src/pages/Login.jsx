        ...
        sx={{
...

            {
                ...
                >
                    ...
                    <Stack>
                    <Button  sx={{marginTop: '1rem', backgroundColor:'#287c8b',border:'1px solid #287c8b', /*'&:hover':{border:'1px solid #ebf9fe'}*/}} variant='contained' color='primary' type='submit' onClick={handleLogin}>Login</Button> 
                ...
                >
                    ...
                    <Button  fullWidth sx={{marginTop: '0.8rem', backgroundColor:'#287c8b'}} variant='contained' color='primary' type='submit' onClick={handleSignUp}>Sign Up</Button>
